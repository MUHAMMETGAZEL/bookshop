    ...
    public class ordersController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.orders != null ? 
                          ...
                          Problem("Entity set 'bookshopContext.orders'  is null.");
        }
        ...
        public async Task<IActionResult> Create(int bookId,int quantity)
        {
            ...
            SqlConnection conn = new SqlConnection("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=C:\\Users\\AL-MANARA\\Documents\\bookshop1.mdf;Integrated Security=True;Connect Timeout=30");
            string sql;
        ...
        {
            var orItems = await _context.reprot.FromSqlRaw("select usersaccounts.id as Id, name as customername, sum (quantity * Price)  as total from book, orders,usersaccounts  where usersaccounts.id = orders.userid  and bookid= book.Id group by name,usersaccounts.id ").ToListAsync();
            return View(orItems);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'bookshopContext.orders'  is null.");
            }
            var orders = await _context.orders.FindAsync(id);
            if (orders != null)
            {
